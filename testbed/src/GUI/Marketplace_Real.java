...
public class Marketplace_Real extends JPanel implements FocusListener, ActionListener {
	...
	public void saveParam() {
		...
		if (textfield[1].getText().equals(DEFAULT[1]) || textfield[1].getText() == null)
			Parameter.setMax_price((Integer.parseInt(DEFAULT[1].substring(DEFAULT[1].indexOf(":")+2))));
		else 
			Parameter.setMax_price(Integer.parseInt(textfield[1].getText()));
		if (textfield[2].getText().equals(DEFAULT[2]) || textfield[2].getText() == null)
			Parameter.setMin_price((Integer.parseInt(DEFAULT[2].substring(DEFAULT[2].indexOf(":")+2))));
		else 
			Parameter.setMin_price(Integer.parseInt(textfield[2].getText()));
