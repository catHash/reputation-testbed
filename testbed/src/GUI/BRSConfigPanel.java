...
public class BRSConfigPanel extends JPanel implements FocusListener, ActionListener
{
    ...
    public void saveParam() {
		if (textfield[0].getText().equals(DEFAULT[0]) || textfield[0].getText() == null)
			Parameter.BRS_quantile = (Double.parseDouble(DEFAULT[0].substring(DEFAULT[0].indexOf(":")+2)));
		else 
			Parameter.BRS_quantile = Double.parseDouble(textfield[0].getText());
	}
